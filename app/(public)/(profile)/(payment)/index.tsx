    ...
    <SafeAreaView style={[MyStyles.main, {backgroundColor:Colours.bg}]} >
      <View style={{width:'90%', flexDirection:'column', marginTop:50, alignSelf:'center', gap:20 }} >
        ...
        <View style={{width:'100%', position:'relative', flexDirection:'row', justifyContent:'center', alignItems:'center', alignSelf:'center'}} >
              ...
              <Text style={MyStyles.welcomeText} >Payments</Text>
        </View>
        ...
        <View style={{width:'100%', flexDirection:'row', justifyContent:'space-between', alignItems:'center'}} >
          ...
          <Pressable onPress={()=>setActiveTab('Confirmed')} style={[styles.tab, {backgroundColor:activeTab==='Confirmed' ?'#cb4900':Colours.bg,}]} >
            <Text style={{color:activeTab === 'Confirmed' ? 'white':'grey', fontWeight:'700',}} >Confirmed</Text>
          </Pressable>
          ...
          <View style={{width:'100%', flexDirection:'column', gap:15, marginBottom:130}} >
            {
              Bookings.map((item:BookingProps)=>(
                <Pressable style={{width:'100%', backgroundColor:'#fff', flexDirection:'row', gap:7, borderRadius:8, padding:4,}} key={item.id} >
                  ...
                  <View style={{flexDirection:'column', height:80, justifyContent:'space-between', gap:2, flexGrow:1}} >
                    ...
                    <View style={{width:'85%', flexDirection:'row', alignItems:'center', justifyContent:'space-between'}} >
                      ...
                      <Text style={{fontSize:18, color:'#cb4900'}} >$200</Text>
                    </View>
                    <View style={{width:'85%', flexDirection:'row', justifyContent:'space-between', alignItems:'center'}} >
                      ...
                      <Pressable style={{flexDirection:'row', alignItems:'center',}} >
                        <EvilIcons name='trash' size={20} color='crimson' />
                      </Pressable>
                    </View>
                  </View>
                </Pressable>
