...
const Tours = ({setCurrentPage}:PageProp) => {
  ...
  return (
    <section className=" flex flex-col items-center gap-8">
      ...
      <NewTour currentData={currentData} setCurrentData={setCurrentData} isNew={isNew} setIsNew={setIsNew} />
      <div className="flex gap-4 flex-col items-center w-[90%]">
        <div className="flex flex-row w-full items-center justify-between">
            ...
            <div className="flex flex-row items-center  gap-1 md:gap-4 self-start">
                ...
                />
                <h2 className="font-semibold text-xl md:text-2xl">Tours</h2>
            </div>
        ...
        <ToursTable search={search} setCurrentData={setCurrentData} />
      </div>
    </section>
  );
}
