  ...
  return (
    <div className="w-full flex flex-col" >
          <div className="flex items-center justify-center md:justify-start md:items-end py-8 w-full bg-no-repeat bg-cover h-60 md:h-96 bg-[linear-gradient(rgba(0,0,0,0.8),rgba(0,0,0,0.7)),url(/packages/people-2557396_1920.jpg)]">
            <span className="text-2xl text-white font-bold text-center ml-0 md:ml-8" >Study Abroad</span>
          </div>
          ...
          <div className="flex flex-col gap-8 items-center py-8 bg-white w-full">
            ...
            <div className="flex flex-col items-center md:items-start gap-4 w-[95%]  lg:w-4/5 xl:w-2/3">
                <span className='text-2xl text-center md:text-left lg:text-4xl font-semibold' >Prerequisite</span>
                ...
                <span className='text-2xl text-center md:text-left lg:text-4xl font-semibold' >Admission</span>
