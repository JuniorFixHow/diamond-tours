...
const Services = () => {
  ...
  return (
    <section id="services" className="w-5/6 scroll-mt-14 flex flex-col py-8 self-center gap-8 items-center justify-center" >
        ...
        <div className="grid place-items-center grid-cols-1 md:grid-cols-2  lg:grid-cols-3 xl:h-max items-start xl:grid-cols-4 gap-8 w-full">
            {
                ...
                ServiceData.map((item:ServicesProps)=>(
                    <div onClick={()=>handleOpenService(item)} key={item?.id} className="rounded-2xl hover:cursor-pointer flex flex-col item-center justify-center w-80 md:w-72 xl:w-64 shadow-xl pb-4">
